const Contact=()=>{
    return(
        <section className="bg-orange-500/10 dark:bg-slate-800" id="contact">
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mb-4">
            <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                <p className="text-base font-semibold uppercase tracking-wide text-orange-500 dark:text-blue-200">
                    Contact
                </p>
                <h2
            ...
            <div className="grid md:grid-cols-2">
                <div className="h-full pr-6">
                    ...
                    <ul className="mb-6 md:mb-0">
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-orange-700 text-gray-50">
                            ...
                            <div className="ml-4 mb-4">
                                <h3 className="mb-2 text-lg font-medium leading-6 text-orange-700 dark:text-white">Our Address
                                </h3>
                        ...
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                <h3 className="mb-2 text-lg font-medium leading-6 text-orange-700 dark:text-white">Contact
                                </h3>
                        ...
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                <h3 className="mb-2 text-lg font-medium leading-6 text-orange-700 dark:text-white">Working
                                    hours</h3>
                ...
                <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                    <h2 className="mb-4 text-2xl font-bold text-orange-500">Ready to Get Started?</h2>
                    <form id="contactForm">
                        <div className="mb-6">
                        ...
                        <div className="text-center">
                            <button type="submit" className="w-full bg-orange-600 text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
